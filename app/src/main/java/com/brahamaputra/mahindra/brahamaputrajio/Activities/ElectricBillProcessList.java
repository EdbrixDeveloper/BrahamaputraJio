...
import com.brahamaputra.mahindra.brahamaputrajio.Adapters.EbProcessTrasactionAdapter;
import com.brahamaputra.mahindra.brahamaputrajio.Application;
import com.brahamaputra.mahindra.brahamaputrajio.Data.EbPaymentRequest;
import com.brahamaputra.mahindra.brahamaputrajio.Data.EbPaymentRequestList;
...
import com.brahamaputra.mahindra.brahamaputrajio.commons.EndlessScrollListener;
...
public class ElectricBillProcessList extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (Constants.eb_billing_process_flag.equals("0")) {
            this.setTitle("Bill Request");//Electricity Billing
        } else if (Constants.eb_billing_process_flag.equals("1")) {
            this.setTitle("Upload DD / Cheque");
        } else if (Constants.eb_billing_process_flag.equals("2")) {
                                ...
                                if (response.getSuccess() == 1) {
                                    ...
                                    if (ebPaymentRequest.getEbPaymentRequestList() != null && ebPaymentRequest.getEbPaymentRequestList().size() > 0) {
                                        ...
                                        for (EbPaymentRequestList ebPaymentRequest :
                                            ...
                                            if (ebPaymentRequest.getStatusId().equals("0") && Constants.eb_billing_process_flag.equals("0")) {
                                                ebPaymentRequestList.add(ebPaymentRequest);
                                            } else if ((ebPaymentRequest.getStatusId().equals("1") || ebPaymentRequest.getStatusId().equals("2")) && Constants.eb_billing_process_flag.equals("1")) {
                                                ebPaymentRequestList.add(ebPaymentRequest);
                                            } else if ((ebPaymentRequest.getStatusId().equals("3") || ebPaymentRequest.getStatusId().equals("4")) && Constants.eb_billing_process_flag.equals("2")) {
                                                ebPaymentRequestList.add(ebPaymentRequest);
                                            }
                                        }
