...
import com.brahamaputra.mahindra.brahamaputrajio.Data.ElectricConnectionData;
...
import com.brahamaputra.mahindra.brahamaputrajio.Volley.JsonRequest;
            ...
            public void onClick(View v) {
                ...
                searchableSpinnerDialog.bindOnSpinerListener(new OnSpinnerItemClick() {
                    ...
                    public void onClick(ArrayList<String> item, int position) {
                        ...
                        Constants.hototicket_sourceOfPower = str_sourceOfPower;
        ...
        try {
            if (offlineStorageWrapper.checkOfflineFileIsAvailable(GlobalMethods.replaceAllSpecialCharAtUnderscore(ticketName) + ".txt")) {
                ...
                if (hotoTransactionData != null) {
                    ...
                    Constants.hototicket_sourceOfPower = hotoTransactionData.getSourceOfPower() == null || hotoTransactionData.getSourceOfPower().isEmpty() ? "" : hotoTransactionData.getSourceOfPower();
                }
