package com.brahamaputra.mahindra.brahamaputrajio.commons;
...
public class CircleLayout extends ViewGroup {
    ...
    protected void init(AttributeSet attrs) {
        ...
        if (attrs != null) {
            TypedArray a = getContext().obtainStyledAttributes(attrs, com.brahamaputra.mahindra.brahamaputrajio.R.styleable.CircleLayout);

            speed = a.getInt(com.brahamaputra.mahindra.brahamaputrajio.R.styleable.CircleLayout_speed, speed);
            radius = a.getDimension(com.brahamaputra.mahindra.brahamaputrajio.R.styleable.CircleLayout_radius, radius);
            isRotating = a.getBoolean(com.brahamaputra.mahindra.brahamaputrajio.R.styleable.CircleLayout_isRotating, isRotating);

            // The angle where the first menu item will be drawn
            angle = a.getInt(com.brahamaputra.mahindra.brahamaputrajio.R.styleable.CircleLayout_firstChildPosition, (int) angle);
    ...
    private class MyGestureListener extends SimpleOnGestureListener {
        ...
        //Below onSingleTapUp is  code change by vinayak //original code commented below this  //code change because on item click immediate open next activity
        @Override
...
*/
        ...
        //Below onSingleTapUp is Original code
       /* @Override
        public boolean onSingleTapUp(MotionEvent e) {
            View tappedView = null;
            int tappedViewsPosition = pointToChildPosition(e.getX(), e.getY());
