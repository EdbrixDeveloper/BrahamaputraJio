...
public class PreventiveMaintenanceSiteBatteryBankCheckPointsActivity extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        assignViews();
        Constants.sitePmBatteryBankType = batteryType.get(0).getTypeOfBattery().toString().trim();//"VRLA";// VRLA Li-Ion
        ...
        visibilityOfFieldsBasedOnBatteryType(Constants.sitePmBatteryBankType);
        initCombo();
        setListner();
                ...
                searchableSpinnerDialog.bindOnSpinerListener(new OnSpinnerItemClick() {
                    ...
                    public void onClick(ArrayList<String> item, int position) {
                        ...
                        if (str_noOfBatteryBankAvailableAtSiteVal.equals("0")) {
                            ...
                            if (Constants.sitePmBatteryBankType.contains("Li-Ion")) {
                                str_pmSiteBbcpTestDoneAs = "Combined";
                                mPreventiveMaintenanceSiteBatteryBankCheckPointsTextViewTestDoneAsVal.setText(str_pmSiteBbcpTestDoneAs);
                                mPreventiveMaintenanceSiteBatteryBankCheckPointsLinearLayoutBatteryBankDischargeTest.setVisibility(View.VISIBLE);
                            }
    ...
    private void submitDetails() {
        try {
            ...
            if (Constants.sitePmBatteryBankType.contains("VRLA") || Constants.sitePmBatteryBankType.contains("Li-Ion")) {
                if ((Constants.sitePmBatteryBankType.contains("VRLA") && testDoneAs.equals("Individual"))) {
                    ...
                    dataList.setTypeOfBattery(Constants.sitePmBatteryBankType);//Li Ion
                    if (batteryBankCheckPointsData.size() > 0) {
                        int i = 0;
                    ...
                    if (batteryBankDischargeTest.equals("Execute BD Test")) {
                        ...
                        } else if (Constants.sitePmBatteryBankType.contains("Li-Ion")) {
            ...
            } else if (Constants.sitePmBatteryBankType.equals("Tubular")) {
                dataList.setBatteryBankCheckPointsData(batteryBankCheckPointsData);
            }
            dataList.setTypeOfBattery(Constants.sitePmBatteryBankType);//008 new
    ...
    public boolean checkValidationOnChangeNoOfDgBatteryAvailable(String NoOfBatteryBankAvailableAtSiteVal, String methodFlag) {
        ...
        if (NoOfBatteryBankAvailableAtSiteVal.isEmpty() || NoOfBatteryBankAvailableAtSiteVal == null) {
            showToast("Select No of Battery Bank available at Site");
            return false;
        } else if ((batteryBankDischargeTest.isEmpty() || batteryBankDischargeTest == null) && (Constants.sitePmBatteryBankType.contains("Li-Ion") || Constants.sitePmBatteryBankType.contains("VRLA")) && !testDoneAs.equals("Individual")) {
            showToast("Select Battery Bank Discharge Test");
            return false;
        } else if ((testDoneAs.isEmpty() || testDoneAs == null) && !Constants.sitePmBatteryBankType.contains("Li-Ion")) {
    ...
    public boolean checkValidationOfArrayFields() {
        ...
        if ((testDoneAs.isEmpty() || testDoneAs == null) && Constants.sitePmBatteryBankType.contains("VRLA")) {
            showToast("Select Test Done as");
            return false;
        } else if ((batteryBankDischargeTest.isEmpty() || batteryBankDischargeTest == null) && (Constants.sitePmBatteryBankType.contains("Li-Ion") || Constants.sitePmBatteryBankType.contains("VRLA")) && !testDoneAs.equals("Individual")) {
            showToast("Select Battery Bank Discharge Test");
            ...
            return false;
        } else if ((batteryBankDischargeTest1.isEmpty() || batteryBankDischargeTest1 == null) && (Constants.sitePmBatteryBankType.contains("VRLA") && testDoneAs.equals("Individual"))) {
            showToast("Select Battery Bank Discharge Test");
            return false;
        } else return true;
    }
    ...
    private void visibilityOfBatteryBankAndDischargeTestFields(String str_pmSiteBbcpTestDoneAs) {
        ...
        if (str_pmSiteBbcpTestDoneAs.equals("Individual") && !Constants.sitePmBatteryBankType.equals("Tubular")) {
        ...
        } else if (str_pmSiteBbcpTestDoneAs.equals("Combined") && !Constants.sitePmBatteryBankType.equals("Tubular")) {
            mPreventiveMaintenanceSiteBatteryBankCheckPointsTextViewBatteryBankDischargeTestVal1.setText("");
            mPreventiveMaintenanceSiteBatteryBankCheckPointsImageViewBatteryBankDischargeTest1.setVisibility(View.GONE);
            mPreventiveMaintenanceSiteBatteryBankCheckPointsLinearLayoutBatteryBankDischargeTest.setVisibility(View.VISIBLE);
            //mPreventiveMaintenanceSiteBatteryBankCheckPointsLinearLayoutSelectBatteryBank.setVisibility(View.GONE);
