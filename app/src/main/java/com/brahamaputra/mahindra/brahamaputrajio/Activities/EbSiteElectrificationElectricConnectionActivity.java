...
public class EbSiteElectrificationElectricConnectionActivity extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (Constants.hototicket_nameOfSupplyCompany.isEmpty() || Constants.hototicket_nameOfSupplyCompany.length() < 0) {
            //
        } else {
            mEbSiteElectrificationElectricConnectionTextViewNameOfSupplyCompanyVal.setText(Constants.hototicket_nameOfSupplyCompany);
