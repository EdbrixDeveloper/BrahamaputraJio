...
import com.brahamaputra.mahindra.brahamaputrajio.BuildConfig;
import com.brahamaputra.mahindra.brahamaputrajio.Data.BatteryBankCheckPointsChildData;
import com.brahamaputra.mahindra.brahamaputrajio.Data.BatteryBankCheckPointsData;
import com.brahamaputra.mahindra.brahamaputrajio.Data.BatteryBankCheckPointsParentData;
import com.brahamaputra.mahindra.brahamaputrajio.Data.BatteryBankCheckPointsViLionBatteryData;
import com.brahamaputra.mahindra.brahamaputrajio.Data.BatteryType;
import com.brahamaputra.mahindra.brahamaputrajio.Data.PreventiveMaintanceSiteTransactionDetails;
import com.brahamaputra.mahindra.brahamaputrajio.R;
import com.brahamaputra.mahindra.brahamaputrajio.Services.AlarmReceiver;
import com.brahamaputra.mahindra.brahamaputrajio.Services.AlarmSoundService;
import com.brahamaputra.mahindra.brahamaputrajio.Services.NotifyService;
import com.brahamaputra.mahindra.brahamaputrajio.Utils.Constants;
import com.brahamaputra.mahindra.brahamaputrajio.Utils.DecimalConversion;
import com.brahamaputra.mahindra.brahamaputrajio.Utils.DecimalDigitsInputFilter;
...
public class PreventiveMaintenanceSiteBatteryBankBackUpTestReportActivity extends BaseActivity {
    ...
    private void visibilityofFieldOnBattery() {
        if (Constants.sitePmBatteryBankType.equals("Li-Ion"))
    ...
    private void getInputDetails(BatteryBankCheckPointsParentData batteryBankCheckPointsParentData) {
        ...
        if (batteryBankCheckPointsParentData != null) {
            ...
            mPreventiveMaintenanceSiteBatteryBankBackUpTestReportTextViewCustomerVal.setText(batteryBankCheckPointsParentData.getBdTestCustomer() == null || batteryBankCheckPointsParentData.getBdTestCustomer().isEmpty() ? Constants.sitePmCustomerName : batteryBankCheckPointsParentData.getBdTestCustomer());
            mPreventiveMaintenanceSiteBatteryBankBackUpTestReportTextViewCircleVal.setText(batteryBankCheckPointsParentData.getBdTestCircle() == null || batteryBankCheckPointsParentData.getBdTestCircle().isEmpty() ? Constants.sitePmCircleName : batteryBankCheckPointsParentData.getBdTestCircle());
            mPreventiveMaintenanceSiteBatteryBankBackUpTestReportTextViewStateVal.setText(batteryBankCheckPointsParentData.getBdTestState() == null || batteryBankCheckPointsParentData.getBdTestState().isEmpty() ? Constants.sitePmStateName : batteryBankCheckPointsParentData.getBdTestState());
            mPreventiveMaintenanceSiteBatteryBankBackUpTestReportTextViewSiteNameVal.setText(batteryBankCheckPointsParentData.getBdTestSiteName() == null || batteryBankCheckPointsParentData.getBdTestSiteName().isEmpty() ? Constants.sitePmSiteName : batteryBankCheckPointsParentData.getBdTestSiteName());
            mPreventiveMaintenanceSiteBatteryBankBackUpTestReportTextViewSiteIdVal.setText(batteryBankCheckPointsParentData.getBdTestSiteId() == null || batteryBankCheckPointsParentData.getBdTestSiteId().isEmpty() ? Constants.sitePmSiteId : batteryBankCheckPointsParentData.getBdTestSiteId());
            mPreventiveMaintenanceSiteBatteryBankBackUpTestReportTextViewSsaVal.setText(batteryBankCheckPointsParentData.getBdTestSsa() == null || batteryBankCheckPointsParentData.getBdTestSsa().isEmpty() ? Constants.sitePmSsaName : batteryBankCheckPointsParentData.getBdTestSsa());
            ...
            mPreventiveMaintenanceSiteBatteryBankBackUpTestReportTextViewBatteryTypeVal.setText(batteryBankCheckPointsParentData.getTypeOfBattery() == null || batteryBankCheckPointsParentData.getTypeOfBattery().isEmpty() ? Constants.sitePmBatteryBankType : batteryBankCheckPointsParentData.getTypeOfBattery());
    ...
    private void getInputDetailsForArray(BatteryBankCheckPointsData batteryBankCheckPointsData) {
        if (batteryBankCheckPointsData != null) {
            ...
            mPreventiveMaintenanceSiteBatteryBankBackUpTestReportTextViewCustomerVal.setText(batteryBankCheckPointsData.getBdTestCustomer() == null || batteryBankCheckPointsData.getBdTestCustomer().isEmpty() ? Constants.sitePmCustomerName : batteryBankCheckPointsData.getBdTestCustomer());
            mPreventiveMaintenanceSiteBatteryBankBackUpTestReportTextViewCircleVal.setText(batteryBankCheckPointsData.getBdTestCircle() == null || batteryBankCheckPointsData.getBdTestCircle().isEmpty() ? Constants.sitePmCircleName : batteryBankCheckPointsData.getBdTestCircle());
            mPreventiveMaintenanceSiteBatteryBankBackUpTestReportTextViewStateVal.setText(batteryBankCheckPointsData.getBdTestState() == null || batteryBankCheckPointsData.getBdTestState().isEmpty() ? Constants.sitePmStateName : batteryBankCheckPointsData.getBdTestState());
            mPreventiveMaintenanceSiteBatteryBankBackUpTestReportTextViewSiteNameVal.setText(batteryBankCheckPointsData.getBdTestSiteName() == null || batteryBankCheckPointsData.getBdTestSiteName().isEmpty() ? Constants.sitePmSiteName : batteryBankCheckPointsData.getBdTestSiteName());
            mPreventiveMaintenanceSiteBatteryBankBackUpTestReportTextViewSiteIdVal.setText(batteryBankCheckPointsData.getBdTestSiteId() == null || batteryBankCheckPointsData.getBdTestSiteId().isEmpty() ? Constants.sitePmSiteId : batteryBankCheckPointsData.getBdTestSiteId());
            mPreventiveMaintenanceSiteBatteryBankBackUpTestReportTextViewSsaVal.setText(batteryBankCheckPointsData.getBdTestSsa() == null || batteryBankCheckPointsData.getBdTestSsa().isEmpty() ? Constants.sitePmSsaName : batteryBankCheckPointsData.getBdTestSsa());
            ...
            mPreventiveMaintenanceSiteBatteryBankBackUpTestReportTextViewBatteryTypeVal.setText(Constants.sitePmBatteryBankType);
            ...
            if (Constants.sitePmBatteryBankType.contains("VRLA")) {
                mLinearLayoutBatteryTypeVRLAAndVRLAPlusReadings.setVisibility(View.VISIBLE);
            ...
            } else if (Constants.sitePmBatteryBankType.equals("Li-Ion")) {
                mLinearLayoutBatteryTypeLiIonReadings.setVisibility(View.VISIBLE);
