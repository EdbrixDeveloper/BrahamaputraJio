...
import com.brahamaputra.mahindra.brahamaputrajio.Data.EbMeterBox;
        ...
        switch (item.getItemId()) {
            ...
            case R.id.menuSubmit:
                if (checkValidationOfArrayFields() == true) {
                    submitDetails();
                    if (Constants.hototicket_sourceOfPower.equals("Non DG") && Constants.sitePmNoOfAcAvailableAtSite.equals("0")) {
                        startActivity(new Intent(this, PreventiveMaintenanceSiteSmpsCheckPointsActivity.class));
                    } else if (Constants.hototicket_sourceOfPower.equals("Non DG")) {
