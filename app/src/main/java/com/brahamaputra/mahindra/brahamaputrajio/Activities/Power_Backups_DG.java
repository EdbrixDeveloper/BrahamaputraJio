...
import com.brahamaputra.mahindra.brahamaputrajio.Data.PowerBackupsDGData;
import com.brahamaputra.mahindra.brahamaputrajio.Data.PowerBackupsDGParentData;
    ...
    private void setInputDetails(int index) {
        try {
            if (offlineStorageWrapper.checkOfflineFileIsAvailable(ticketName + ".txt")) {
                ...
                mPowerBackupsDgTextViewNoOfEngineAlternatorSetsprovidedVal.setText(Constants.hototicket_sourceOfPower.equals("Non DG") ? "0" : powerBackupsDGParentData.getNoOfEngineAlternator());
