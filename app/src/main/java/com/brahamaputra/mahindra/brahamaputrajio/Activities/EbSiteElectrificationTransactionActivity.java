...
import com.brahamaputra.mahindra.brahamaputrajio.Data.EbSiteElectrificationElectricConnectionData;
import com.brahamaputra.mahindra.brahamaputrajio.Data.EbSiteElectrificationSubmitResposeData;
import com.brahamaputra.mahindra.brahamaputrajio.Data.EbSiteElectrificationTransactionData;
...
public class EbSiteElectrificationTransactionActivity extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mEbSiteElectrificationTransactionButtonSubmitEbSiteElectrificationTransaction.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                //submitDetails();
                Constants.hototicket_Selected_SiteType = mEbSiteElectrificationTransactionEditTextTypeOfSite.getText().toString();
                Constants.hototicket_Selected_CustomerName = mEbSiteElectrificationTransactionEditTextCustomerName.getText().toString();
    ...
    private void submitDetails() {
        try {
            ...
            ebSiteElectrificationTransactionData.setSiteId(Constants.ebSiteElectrificationSiteDbId);
