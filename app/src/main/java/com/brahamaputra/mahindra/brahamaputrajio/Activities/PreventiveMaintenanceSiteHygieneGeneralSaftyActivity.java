...
import com.brahamaputra.mahindra.brahamaputrajio.Data.SiteHygenieneGenralSeftyParameter;
...
public class PreventiveMaintenanceSiteHygieneGeneralSaftyActivity extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        visibilityOfCompoundWallFencingStatus(Constants.sitePm_siteBoundaryStatus);
        visibilityOfShelterLockAvailablity(Constants.hototicket_Selected_SiteType);
        visibilityOfDgLockAvailablity(Constants.hototicket_sourceOfPower);
    ...
    public boolean checkValidationOfArrayFields() {
        ...
        if (sitePremisesCleaning.isEmpty() || sitePremisesCleaning == null) {
            ...
            return false;
        } else if ((compoundWallFencingStatus.isEmpty() || compoundWallFencingStatus == null) && (!Constants.sitePm_siteBoundaryStatus.equals("Not Applicable") && !Constants.sitePm_siteBoundaryStatus.equals("Open Site"))) {
            ...
            return false;
        } else if ((shelterLockAvailability.isEmpty() || shelterLockAvailability == null) && (!Constants.hototicket_Selected_SiteType.equals("Outdoor"))) {
            showToast("Select Shelter Lock Availability");
            return false;
        } else if ((dgLockAvailability.isEmpty() || dgLockAvailability == null) && (!Constants.hototicket_sourceOfPower.equals("Non DG"))) {
