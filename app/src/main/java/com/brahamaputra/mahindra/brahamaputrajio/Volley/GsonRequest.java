package com.brahamaputra.mahindra.brahamaputrajio.Volley;
...
public class GsonRequest<T> extends Request<T> {
    ...
    public Map<String, String> getHeaders() throws AuthFailureError {
        ...
        headers.put("Client-Version", Application.APP_VERSION);
        headers.put("Device-Token", Application.ANDROID_ID);
    ...
    protected Response<T> parseNetworkResponse(NetworkResponse response) {
        try {
            ...
            T result = SettingsMy.getGsonParser().fromJson(json, clazz);
