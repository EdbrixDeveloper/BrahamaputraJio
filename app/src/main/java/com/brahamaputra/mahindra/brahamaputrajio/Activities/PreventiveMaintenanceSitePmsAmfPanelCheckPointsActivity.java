...
import com.brahamaputra.mahindra.brahamaputrajio.Data.PmsAmfPanelCheckPointsParentData;
import com.brahamaputra.mahindra.brahamaputrajio.Data.PmsAmfPanelCheckPointsData;
                    ...
                    if (currentPos < (totalCount - 1)) {
                        ...
                        if (checkDuplicationQrCodeNew() == false) {
                            if (checkValidtionForNoOfPmsAmfPuiAvailabelAtSite("onSubmit") == true) {
                                submitDetails();
                                if (Constants.sitePmServoStabilizerWorkingStatus.equals("Not Available") && Constants.hototicket_Selected_SiteType.equals("Outdoor")) {
                                    ...
                                    finish();
                                } else if (Constants.sitePmServoStabilizerWorkingStatus.equals("Not Available")) {
