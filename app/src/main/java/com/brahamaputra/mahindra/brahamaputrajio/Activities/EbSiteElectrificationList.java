...
import com.brahamaputra.mahindra.brahamaputrajio.Adapters.EbSiteElectrificationTicketListAdapter;
import com.brahamaputra.mahindra.brahamaputrajio.Application;
import com.brahamaputra.mahindra.brahamaputrajio.Data.EbSiteElectrificationTicketList;
import com.brahamaputra.mahindra.brahamaputrajio.Data.EbSiteElectrificationTransaction;
                ...
                if (!gps_enabled && !network_enabled) {
                    ...
                    if (gpsTracker.getLongitude() > 0 && gpsTracker.getLongitude() > 0) {
                        if (ebSiteElectrificationTicketList != null) {
                            ...
                            Constants.ebSiteElectrificationSiteDbId= ebSiteElectrificationTicketList.getEbSiteElectrificationTransaction().get(position).getSiteDBId().toString();
                            ...
                            Constants.hototicket_nameOfSupplyCompany = ebSiteElectrificationTicketList.getEbSiteElectrificationTransaction().get(position).getNameOfSupplyCompany().toString();
                            ...
                            Constants.ebSiteElectrificationConsumerNumber = ebSiteElectrificationTicketList.getEbSiteElectrificationTransaction().get(position).getConsumerNumber().toString();
                            ...
                            Constants.ebSiteElectrificationEbMeterSerialNumber = ebSiteElectrificationTicketList.getEbSiteElectrificationTransaction().get(position).getEbMeterSerialNumber().toString();
